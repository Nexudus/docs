...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Maximum additional company aliases**                     | Set the number of additional company aliases allowed, excluding the one provided during onboarding.                 | This is measured in aliases.                                          |
| **Maximum additional recipients**                     | Set the number of additional nominated recipients allowed, excluding those provided during onboarding.                 | This is measured in recipients.                                          |
| **Maximum forwarding addresses per recipient**                     | Set the maximum number of forwarding addresses allowed per recipient.                 | This is measured in addresses.                                          |
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Bookings**                     | Discount percentage for bookings.                 | Default value is 20%. Members in this plan get a discount off their bookings.                                          |
| **Passes**                     | Discount percentage for passes.                 | Default value is 20%. Members in this plan get a discount off their passes, including PAYG passes.                                          |
| **Charges**                     | Discount percentage for charges.                 | Default value is 20%. Members in this plan get a discount off their charges.                                          |
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Customers in this plan can cancel their plan from the portal or the app.**                     | Allows customers to cancel their plan through the portal or app.                 | Reversed logic: Unchecking this box means customers can cancel.                                          |
...
| **Maximum number of members**                     | Sets a limit on the number of members allowed in this plan.                 | Default is 100 members; can be adjusted as needed.                                          |
...
| **Cancellation notice period**                     | Defines the notice period required for cancellation.                 | Default is 30 days; can be set to zero for no notice period.                                          |
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Days of access per billing cycle**                     | Limit the number of days per billing cycle customers can access.                 | Default is 20 days. Set to 0 for unlimited access.                                          |
| **Days of access per month**                     | Limit the number of days per month customers can access.                 | Default is 20 days. Set to 0 for unlimited access.                                          |
| **Days of access per week**                     | Limit the number of days per week customers can access.                 | Default is 5 days. Set to 0 for unlimited access.                                          |
<Note>Use these restrictions carefully! These are hard limits. Once reached, customers cannot check in, book, or bring more guests.</Note>
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Hours of access per billing cycle**                     | Limit the number of hours per billing cycle customers can access.                 | Default is 100 hours. Set to 0 for unlimited access.                                          |
| **Hours of access per month**                     | Limit the number of hours per month customers can access.                 | Default is 100 hours. Set to 0 for unlimited access.                                          |
| **Hours of access per week**                     | Limit the number of hours per week customers can access.                 | Default is 5 hours. Set to 0 for unlimited access.                                          |
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Booking minutes per month**                     | Limit the number of minutes per month customers can book.                 | Default is 600 minutes. Set to 0 for unlimited booking.                                          |
| **Booking minutes per week**                     | Limit the number of minutes per week customers can book.                 | Default is 60 minutes. Set to 0 for unlimited booking.                                          |
...
| **Field**                             | **Description**                      | **Tips & Notes**      |
| ------------------------------------- | ------------------------------------ | --------------------- |
| **Visitors per month**                     | Limit the number of visitors per month customers can receive.                 | Default is 8 visitors. Set to 0 for unlimited visitors.                                          |
| **Visitors per week**                     | Limit the number of visitors per week customers can receive.                 | Default is 2 visitors. Set to 0 for unlimited visitors.                                          |
| **Visitors per day**                     | Limit the number of visitors per day customers can receive.                 | Default is 1 visitor. Set to 0 for unlimited visitors.                                          |
