...
| **Display this resource in the administration panel calendar.**  | Visibility toggle for the admin panel calendar.  |                                                                   |
...
| **Field**          | **Description**                                       | **Tips & Notes**                                                              |
| ------------------ | ----------------------------------------------------- | ----------------------------------------------------------------------------- |
| **Resource types** | The type of resource for which the rate is being set. | Ensure the resource type is correctly selected to apply the appropriate rate. |
...
| **Field**      | **Description**                              | **Tips & Notes**                                            |
| -------------- | -------------------------------------------- | ----------------------------------------------------------- |
| **Time slots** | Define the available times for the resource. | If no time slots are set, the resource is always available. |
...
| **Field**                                                             | **Description**                                 | **Tips & Notes**                                   |
| --------------------------------------------------------------------- | ----------------------------------------------- | -------------------------------------------------- |
| **Simultaneous bookings**                                             | Enable simultaneous bookings for this resource. | Useful for resources like hot-desks.               |
| **Capacity**                                                          | Define the capacity of the resource.            | Specify the number of bookings or persons allowed. |
| **Limit the number of guests in each booking based on the capacity.** | Limit the number of guests based on capacity.   | Ensures guest numbers do not exceed capacity.      |
...
| **Field**                                                                    | **Description**                                         | **Tips & Notes**                   |
| ---------------------------------------------------------------------------- | ------------------------------------------------------- | ---------------------------------- |
| **Advanced bookings**                                                        | Set the maximum hours in advance a booking can be made. | Default is 24 hours.               |
| **Late bookings**                                                            | Set the minimum hours before a booking starts.          | Default is 1 hour.                 |
| **Late cancellations**                                                       | Options for handling late cancellations.                | May include a cancellation fee.    |
| **Bookings for this resource must be always confirmed by an administrator.** | Require administrator confirmation for bookings.        | Ensures all bookings are reviewed. |
...
| **Field**                                                  | **Description**                         | **Tips & Notes**                                    |
| ---------------------------------------------------------- | --------------------------------------- | --------------------------------------------------- |
| **Maximum duration**                                       | Set the maximum duration for a booking. |                                                     |
| **Minimum duration**                                       | Set the minimum duration for a booking. |                                                     |
| **Fixed interval**                                         | Set fixed intervals for bookings.       | Only accepts 15-minute intervals.                   |
| **Limit the start/end times when booking this resources.** | Define start/end times for bookings.    | Useful for resources with specific operating hours. |
...
| **Field**                                                                 | **Description**                                               | **Tips & Notes**                                       |
| ------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------ |
| **This resource can be booked by:**                                       | Define who can book the resource.                             | Options include members, contacts, and specific teams. |
| **Restrict the teams which can book this resource to:**                   | Define which teams can book this resource                     | If empty, all teams can book this resource.            |
| **This resource can only be booked by customers with a home location of** | Restrict bookings to customers with a specific home location. | Useful for businesses with multiple locations.         |
...
| **Field**                                           | **Description**                                                | **Tips & Notes**                                |
| --------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------- |
| **This resource locks other resources when booked** | Select resources that are locked when this resource is booked. | Ensures combined resources are booked together. |
...
| **Field**              | **Description**                      | **Tips & Notes**                     |
| ---------------------- | ------------------------------------ | ------------------------------------ |
| **No-return policies** | Set rules for gaps between bookings. | Useful for cleaning and preparation. |
...
<Note>
  If no Zoom user is connected, a button to connect is shown. If a Zoom user is
  connected, a button to disconnect is shown.
</Note>
